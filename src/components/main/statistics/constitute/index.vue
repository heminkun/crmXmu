    ...
    <div class="flex column" style="width: 100%;">
      <div class="flex column" style="background-color: white;position: relative;padding-bottom: 20px;justify-content: center">
        ...
        <el-table v-loading="state.contribute.loading" :data="state.contribute.data">
          <el-table-column label="序号" prop="custLevelId">
          </el-table-column>
          <el-table-column label="等级" prop="custLevelName">
          </el-table-column>
          <el-table-column label="客户数量" prop="custAmount">
          </el-table-column>
        </el-table>
      </div>
    </div>
...
const getData = () => {
  ...
  axios.get("/cstLevel/loadDataList",).then((res)=>{
