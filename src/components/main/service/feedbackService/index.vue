      ...
      <el-dialog @close="dialogClose" v-model="state.dialog.dialogSw">
        ...
        <el-descriptions
          ...
          <el-descriptions-item>
            ...
            <el-select v-model="state.dialog.svrSatisfy">
              <el-option
              v-for="item in state.dialog.svrSatisfyList"
              :value="item.value"
              :label="item.label"
              >
              </el-option>
          ...
          <el-descriptions-item>
            ...
            <el-input v-model="state.dialog.svrResult" type="textarea"></el-input>
          </el-descriptions-item>
        </el-descriptions>
...
const save = () => {
  if (state.dialog.svrResult!=null&&state.dialog.svrResult!=""){
    const bean={
      svrId:state.dialog.dialogData.svrId,
      svrResult:state.dialog.svrResult,
      svrSatisfy:state.dialog.svrSatisfy,
      svrStatus:"已反馈"
    }
