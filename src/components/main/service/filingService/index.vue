    ...
    <div class="flex column" style="width: 100%;">
      <div class="flex column" style="background-color: white;position: relative;padding-bottom: 20px;justify-content: center">
        ...
        <el-table v-loading="state.svr.loading" :data="state.svr.svrData">
          ...
          <el-table-column prop="svrDueTo" label="分配人"></el-table-column>
          <el-table-column prop="svrDueDate" label="分配时间"></el-table-column>
          <el-table-column prop="svrDealBy" label="处理人"></el-table-column>
          <el-table-column label="处理">
            <template #default="{row}">
              <el-button @click="openDialog(row)" size="small" type="primary">查看</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
      ...
      <el-dialog @close="dialogClose" v-model="state.dialog.dialogSw">
        ...
        <el-descriptions
          ...
          <el-descriptions-item>
            ...
            {{state.dialog.dialogData.svrDeal}}
          </el-descriptions-item>
          <el-descriptions-item>
          </el-descriptions-item>
          <el-descriptions-item>
            ...
            {{state.dialog.dialogData.svrDealBy}}
          </el-descriptions-item>
          <el-descriptions-item>
            <template #label>
              <div class="cell-item">
            ...
            {{state.dialog.dialogData.svrDealDate}}
          </el-descriptions-item>
        </el-descriptions>
        <el-descriptions
            border
          ...
          <el-descriptions-item>
            ...
            <span v-if="state.dialog.dialogData.svrSatisfy==1">⭐</span>
            <span v-if="state.dialog.dialogData.svrSatisfy==2">⭐⭐</span>
            <span v-if="state.dialog.dialogData.svrSatisfy==3">⭐⭐⭐</span>
            <span v-if="state.dialog.dialogData.svrSatisfy==4">⭐⭐⭐⭐</span>
            <span v-if="state.dialog.dialogData.svrSatisfy==5">⭐⭐⭐⭐⭐</span>
          </el-descriptions-item>
          <el-descriptions-item>
            <template #label>
              <div class="cell-item">
            ...
            {{state.dialog.dialogData.svrResult}}
          </el-descriptions-item>
        </el-descriptions>
      </el-dialog>
    </div>
